...
var oasOpSecurityDefined = {};

var require$$0$1 = /*@__PURE__*/getAugmentedNamespace(spectralCore);

var getAllOperations$1 = {};
...
function isObject$2(maybeObj) {
  return maybeObj !== null && typeof maybeObj === 'object';
}

function isObjectLiteral(obj) {
  if (!isObject$2(obj)) return false;
...
Object.defineProperty(getAllOperations$1, "__esModule", { value: true });
getAllOperations$1.getAllOperations = void 0;
const json_1 = require$$0;
...
getAllOperations$1.getAllOperations = getAllOperations;
...
Object.defineProperty(oasOpSecurityDefined, "__esModule", { value: true });
const spectral_core_1 = require$$0$1;
const getAllOperations_1 = getAllOperations$1;
...
var _default = oasOpSecurityDefined.default = (0, spectral_core_1.createRulesetFunction)({
    input: {
        type: 'object',
        properties: {
            paths: {
